    ...
    render(){
        ...
        return (
            ...
            <div className = "flex flex-col pb-4">
                    <div className = "">
                        <RangeSlider aria-label={['min', 'max']} defaultValue={[this.props.minPrice,this.props.maxPrice]} step={25} min={0} max={2000} onChangeEnd = {(val) => this.updateSelectedPrices(val)}>
